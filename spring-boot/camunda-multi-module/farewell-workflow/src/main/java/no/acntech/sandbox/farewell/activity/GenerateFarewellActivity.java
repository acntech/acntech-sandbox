...
@Component
public class GenerateFarewellActivity implements JavaDelegate {

    private static final Logger LOGGER = LoggerFactory.getLogger(GenerateFarewellActivity.class);
    ...
    public void execute(final DelegateExecution delegateExecution) {
        try {
            ...
            delegateExecution.setVariable("Farewell", "Goodbye " + firstName + "!");
        } catch (Exception e) {
