    ...
    <jsp:body>
        <main class="container" role="main">
            <div class="starter-template">
                <div class="jumbotron">
                    <h1><spring:message code="authors.page.title"/></h1>
                    ...
                    <div class="panel-group">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form:form method="POST" action="${pageContext.request.contextPath}/authors"
                                           modelAttribute="author">
                                    <div class="form-group">
                                        <form:label path="firstName"><spring:message
                                                code="form.input.author.firstName"/>:</form:label>
                                    ...
                                    <div class="form-group">
                                        <form:label path="biography"><spring:message
                                                code="form.input.author.biography"/>:</form:label>
                                        <form:input class="form-control" path="biography"/>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-default"><spring:message
                                                code="form.button.create.author"/></button>
                                    </div>
                                </form:form>
                            </div>
                        </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form:form method="GET" action="${pageContext.request.contextPath}/authors">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-default"><spring:message
                                                    code="form.button.find.authors"/></button>
                                        </div>
                                    </form:form>
                                </div>
                            </div>
